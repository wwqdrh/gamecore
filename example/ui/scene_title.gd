...
<ui>
  ...
  <PopupPanel name="SettingsPopup" popup_title="Settings" popup_width="420" close_on_overlay="true">
	<ScrollContainer size_flags_vertical="expand_fill" horizontal="disabled" vertical="auto">
	  <VBoxContainer v_separation="8">
		...
		<HBoxContainer class="row-bg">
		  ...
		  <HSlider name="MasterVolSlider" min_value="0" max_value="100" value="80" step="1" custom_minimum_size="120,0" />
        </HBoxContainer>
		<HBoxContainer class="row-bg">
		  ...
		  <HSlider name="MusicVolSlider" min_value="0" max_value="100" value="70" step="1" custom_minimum_size="120,0" />
        </HBoxContainer>
		<HBoxContainer class="row-bg">
		  <Label text="SFX Volume" class="label-text" size_flags_horizontal="expand_fill" />
		  <Label name="SfxVolLabel" text="90" class="value-text" />
		  <HSlider name="SfxVolSlider" min_value="0" max_value="100" value="90" step="1" custom_minimum_size="120,0" />
        </HBoxContainer>
		...
		<HBoxContainer margin="0 8 0 0">
		  <Control size_flags_horizontal="expand_fill" />
		  <Button text="Apply" class="apply-btn" custom_minimum_size="100,36" on_pressed="hide:SettingsPopup" />
		  <Button text="Cancel" class="cancel-btn" custom_minimum_size="100,36" on_pressed="hide:SettingsPopup" />
        </HBoxContainer>
      </VBoxContainer>
    </ScrollContainer>
  </PopupPanel>
